...
# One destination only. This used to fan out to SPECTOR_MEMORY_DIMENSIONS as well, because
# dimensionality was configured twice; that property has been removed and is now refused at startup.
