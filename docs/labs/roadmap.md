...
This is common in ADHD: you can't remember the specific thing you were looking for, but a tangential mention triggers a cascade of related memories. The [STDP infrastructure](../memory/association-graph.md#layer-1-hebbian-association-graph) now makes this possible — directed causal edges encode "thinking about A leads to thinking about B."
