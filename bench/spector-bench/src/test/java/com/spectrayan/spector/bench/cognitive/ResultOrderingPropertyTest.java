 ...
 * sorted in strictly descending score order, all scores SHALL be > 0.0, and N â‰¤ topK.
 */
class ResultOrderingPropertyTest {
    ...
    // Property 12: Results sorted descending, scores > 0, count â‰¤ topK
    // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
    ...
    void results_sortedDescending_positiveScores_withinTopK(
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            List<CognitiveScorer.ScoredRecord> results = CognitiveScorer.score(EngramRegion.of(segment, corpusSize, layout), queryVector, options, nowMs);
