    ...
    public static void main(String[] args) {
        String defaultDataDir = System.getProperty(
                ...
                System.getProperty("spector.bench.dataset.dir",
                        System.getenv().getOrDefault("DATASET_DIR", "../spector-datasets/locomo/data")));
        Path datasetDir = Paths.get(defaultDataDir);
        Path outputDir = Paths.get(System.getProperty("outputDir", "target/benchmark-results/locomo"));
        int topK = 10;
