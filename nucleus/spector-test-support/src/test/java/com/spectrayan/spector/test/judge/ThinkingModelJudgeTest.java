 ...
 * the JSON appears â€” outside or inside the thinking block.</p>
 */
@DisplayName("LlmTestJudge â€” Thinking Model Support")
class ThinkingModelJudgeTest {
    ...
    class EdgeCaseTests {
        ...
        void missingRelevantField() {
            ...
            // JSON_EXTRACT regex requires "relevant" field â€” without it, treated as parse failure
