...
public class HebbianGraph implements HebbianGraphBase {
    ...
    /**
     * @deprecated Use top-level {@link com.spectrayan.spector.memory.graph.hebbian.DecayModulator} directly.
     */
    @Deprecated(since = "1.0.0", forRemoval = true)
    @FunctionalInterface
    public interface DecayModulator extends com.spectrayan.spector.kernel.store.DecayModulator {
    }
    ...
    public HebbianGraph(int capacity, int maxDegree) {
        this(capacity, maxDegree, EdgeImportance.DEFAULT);
    }
    ...
    public HebbianGraph(Path filePath, int capacity, int maxDegree) {
        this(filePath, capacity, maxDegree, EdgeImportance.DEFAULT);
    }
