...
public final class WorkingMemory extends AbstractEngramMemory<WorkingLayout> {
    ...
    public static WorkingMemory fromRegionRef(com.spectrayan.spector.kernel.bundle.RegionRef regionRef,
                                              int capacity, int quantizedVecBytes,
                                              Path bundlePath, boolean isNew) {
        return new WorkingMemory(regionRef, capacity, quantizedVecBytes, bundlePath, isNew);
    }

    private WorkingMemory(com.spectrayan.spector.kernel.bundle.RegionRef regionRef, int capacity,
