 ...
 *   <tr><td><b>Engram</b></td><td>One stored memory trace</td><td>{@link com.spectrayan.spector.kernel.layout.EngramLayout} (becoming {@code EngramLayout})</td><td>Trace \(T\)</td></tr>
 *   <tr><td><b>Preamble</b></td><td>Fixed prologue of a region or store file (64 bytes)</td><td>{@link com.spectrayan.spector.kernel.region.RegionPreamble}</td><td>Physical container prologue</td></tr>
 *   <tr><td><b>Region Layout</b></td><td>Descriptor of a region's records (stride, schema, CRC)</td><td>{@link com.spectrayan.spector.kernel.layout.RegionLayout}</td><td>Physical record descriptor</td></tr>
 ...
 *   <tr><td><b>Strength State</b></td><td>Recall dynamics: \(D\), \(S\), recall counts, ACT-R ring, last access</td><td>{@link com.spectrayan.spector.kernel.layout.StrengthLayout}, {@code StrengthState}</td><td>Part of logical {@code header}</td></tr>
 ...
 *   <tr><td><b>Location</b></td><td>Physical address within memory</td><td>{@link com.spectrayan.spector.kernel.api.MemoryLocation}</td><td>Location \(L\)</td></tr>
 ...
 *   <tr><td><b>Shape</b></td><td>Access pattern: record, append, graph, chain, registry</td><td>{@link com.spectrayan.spector.kernel.shape.MemoryShape}, {@code kernel.shape.*}</td><td>Physical shape abstraction</td></tr>
 ...
 * (e.g. {@link com.spectrayan.spector.kernel.region.RegionPreamble#PREAMBLE_BYTES}).</p>
 *
 * <h2>The Shape Rule</h2>
 * <p><b>Shape belongs on the shape abstraction, never on a concrete store or layout.</b>
 * Types in {@code com.spectrayan.spector.kernel.shape.*} legitimately carry shape tokens
