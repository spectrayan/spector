...
import com.spectrayan.spector.kernel.layout.ProvenanceLayout.ProvenanceState;
...
public final class ProvenanceMemory extends AbstractRecordMemory<ProvenanceLayout> {
    ...
    public static ProvenanceMemory fromRegionRef(com.spectrayan.spector.kernel.bundle.RegionRef regionRef, Path bundlePath, String memoryName) {
        String name = (memoryName != null && !memoryName.isBlank()) ? memoryName : "bundle-provenance";
    ...
    public static ProvenanceMemory fromRegionRef(com.spectrayan.spector.kernel.bundle.RegionRef regionRef, Path bundlePath) {
