...
public final class LegacyEncodingHeaderReader {
    ...
    public com.spectrayan.spector.kernel.api.EngramSource readSource(MemorySegment seg, long off) {
        return com.spectrayan.spector.kernel.api.EngramSource.fromCode(readSourceCode(seg, off));
    }
