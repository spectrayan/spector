...
public final class TemporalChainMemory extends AbstractChainMemory<TemporalLayout> implements AutoCloseable {
    ...
    public static TemporalChainMemory fromRegionRef(com.spectrayan.spector.kernel.bundle.RegionRef regionRef, int capacity, Path bundlePath, boolean isNew) {
        int resolvedCap = capacity;
    ...
    private TemporalChainMemory(com.spectrayan.spector.kernel.bundle.RegionRef regionRef, int capacity, Path bundlePath, boolean isNew) {
