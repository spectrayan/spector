...
class CausalQueryEngineTest {
    ...
    void traceWhyDirectOneHop() {
        ...
        var temporalQuery = mock(com.spectrayan.spector.memory.graph.temporal.TemporalQuery.class);
        ...
        var emptyQuery = mock(com.spectrayan.spector.memory.graph.temporal.TemporalQuery.class);
    ...
    void traceWhyMultiHopThreeSteps() {
        ...
        var q0 = mock(com.spectrayan.spector.memory.graph.temporal.TemporalQuery.class);
        ...
        var q1 = mock(com.spectrayan.spector.memory.graph.temporal.TemporalQuery.class);
        ...
        var q2 = mock(com.spectrayan.spector.memory.graph.temporal.TemporalQuery.class);
        ...
        var q3 = mock(com.spectrayan.spector.memory.graph.temporal.TemporalQuery.class);
    ...
    void facadeDelegation() {
        ...
        var emptyQ = mock(com.spectrayan.spector.memory.graph.temporal.TemporalQuery.class);
