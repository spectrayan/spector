 ...
 * <p>Validates the full ingest â†’ index â†’ recall pipeline using production-grade
 ...
 *   <li>Text search mode switching (HYBRID â†’ KEYWORD_ONLY â†’ VECTOR_ONLY) works</li>
...
class OllamaRetrievalStackTest {
    ...
    @Test
    @Order(1)
    @DisplayName("BM25 keyword recall â€” exact-term matches found in keyword-only mode")
    ...
    @Test
    @Order(2)
    @DisplayName("BM25 no false positives â€” unrelated query returns empty or very low scores")
    ...
    // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
    // Hybrid Mode â€” BM25 + Vector
    // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•

    @Test
    @Order(3)
    @DisplayName("Hybrid recall â€” combines keyword AND semantic matches")
    ...
    @Test
    @Order(4)
    @DisplayName("Vector-only recall â€” semantic similarity with real embeddings")
    ...
    @Test
    @Order(5)
    @DisplayName("Text search mode switching â€” HYBRID, KEYWORD_ONLY, VECTOR_ONLY all work")
    ...
    @Test
    @Order(6)
    @DisplayName("Concurrent recall â€” 5 threads, real Ollama embeddings, no crashes")
    ...
    // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
    // Full E2E: Ingest 50 â†’ Recall with Relevance Ordering
    // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•

    @Test
    @Order(7)
    @DisplayName("E2E 50-doc ingest + recall â€” real embeddings, verify relevance ordering")
    void ingestRecall_e2e_50docs() throws Exception {
        ...
        for (int i = 0; i < 50; i++) {
            String text = domainTopics[i % domainTopics.length] + " â€” instance " + i;
    ...
    @Test
    @Order(8)
    @DisplayName("Cross-tier keyword recall â€” BM25 finds matches across all memory tiers")
