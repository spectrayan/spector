...
import com.spectrayan.spector.memory.pathway.pipeline.reranker.CognitiveReranker;
import com.spectrayan.spector.memory.pathway.pipeline.graph.GraphExpander;
 ...
 * </ul>
 *
 * @deprecated Superceded by {@link com.spectrayan.spector.memory.pathway.recall.RecallPathway} as part of the
...
public final class RecallPipeline {
    ...
    private final com.spectrayan.spector.memory.pathway.pipeline.reranker.MmrReranker mmrReranker;
    ...
    private final com.spectrayan.spector.memory.neuromod.dopamine.SurpriseDetector surpriseDetector;
    ...
    public RecallPipeline(EmbeddingProvider embeddingProvider,
                           ...
                           RecallHistory recallHistory,
                           com.spectrayan.spector.memory.pathway.pipeline.reranker.MmrReranker mmrReranker,
                           com.spectrayan.spector.memory.neuromod.dopamine.SurpriseDetector surpriseDetector,
        ...
        this.temporalFactWeavingStage = new com.spectrayan.spector.memory.pathway.pipeline.graph.TemporalFactWeavingStage(
