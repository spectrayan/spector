 ...
 * <ol>
 *   <li><b>Novelty</b> â€” Welford z-score from {@link SurpriseDetector} (peek, not update)</li>
 *   <li><b>ICNU Fusion</b> â€” Interest/Challenge/Novelty/Urgency weights from {@link IcnuWeights}</li>
 *   <li><b>Flashbulb</b> â€” extreme-surprise detection from {@link FlashbulbPolicy}</li>
 *   <li><b>Nearest neighbour</b> â€” distance to closest existing memory (diversity signal)</li>
 * </ol>
 *
...
final class ImportanceEstimator {
    ...
    ImportanceEstimate estimate(String text,
        ...
        try {
            ...
            // Step 2: Compute nearest distance (read-only â€” don't update stats)
            float nearestDist;
            ...
            // Step 3: Compute novelty (read-only peek â€” don't modify Welford stats)
