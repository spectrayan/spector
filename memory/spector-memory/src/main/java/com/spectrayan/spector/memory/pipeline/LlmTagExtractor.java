 ...
 * <h3>How It Works</h3>
 * <p>
 * Sends a structured prompt to the LLM asking it to identify 5â€“10
 ...
 * <p>
 * LLM inference adds ~500msâ€“2s per chunk. Use this extractor for
...
public final class LlmTagExtractor implements TagExtractor {
    ...
    /** Max length for a single tag â€” anything longer is almost certainly prompt leakage. */
    ...
    /**
     * Substrings that indicate prompt leakage â€” if a tag contains any of these,
     ...
     * "hairvalence-56arousal-192" â€” these patterns catch all variants:
    ...
    public TagExtractionResult extractWithContext(String id, String text) {
        ...
        try {
            ...
            log.debug("[TagExtract] LLM prompt for '{}': {} chars (text: {} â†’ {})",
            ...
            if (tagLine == null) {
                ...
                if (hasSlashTags) {
                    // Model produced slash-separated tags â€” normalize to comma-separated
                    ...
                    // the model likely echoed the prompt â€” fall back immediately
            ...
            // â”€â”€ Smart extraction of valence/arousal embedded in the tag stream â”€â”€
            // Models sometimes concatenate everything: "cleanliness/valence-105/arousal-234"
            // which after slashâ†’comma becomes "cleanliness,valence-105,arousal-234"
