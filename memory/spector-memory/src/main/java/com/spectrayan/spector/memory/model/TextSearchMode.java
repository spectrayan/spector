 ...
 * a {@link com.spectrayan.spector.provider.embedding.SparseEmbeddingProvider}), the pipeline will
...
public enum TextSearchMode {
     ...
     * Requires both SparseEmbeddingProvider and TokenEmbeddingProvider.</p>
     */
    FULL_STACK;
