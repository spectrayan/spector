...
public enum MemorySource {
    ...
    /**
     * Generated during REM dream cycle (lowest confidence — prior to test, not fact).
     */
    DREAMED(0.3f),

    /**
     * Generated by waking counterfactual simulation.
     */
    THOUGHT_EXPERIMENT(0.4f),

    /**
     * Discovered via Langevin diffusion exploration.
     */
    LANGEVIN_DISCOVERY(0.3f);
