...
class RetrievalBenchmarkTest {
    ...
    void simd_addArrays_100K_under_1ms() {
        ...
        System.out.printf("SIMD addArrays 100K: %,d us%n", elapsed / 1000);
    ...
    void simd_fmaArrays_100K_under_1ms() {
        ...
        System.out.printf("SIMD fmaArrays 100K: %,d us%n", elapsed / 1000);
    ...
    void simd_maxValue_100K_under_500us() {
        ...
        System.out.printf("SIMD maxValue 100K: %,d us (max=%.4f)%n", elapsed / 1000, max);
    ...
    void splade_10K_search_under_5ms() {
        ...
        System.out.printf("SpladeIndex 10K search: %,d us  ->  %d results%n",
    ...
    void splade_bulkIndex_1K_under_500ms() {
        ...
        System.out.printf("SpladeIndex bulk 1Kx100: %,d ms (%d docs)%n",
    ...
    @Test
    @Order(6)
    @DisplayName("ColBERT MaxSim  --  rerank 50 candidates x 128-dim under 50ms")
    void colbert_maxSim_50_under_50ms() {
        ...
        System.out.printf("ColBERT rerank 50x%d-dim: %,d ms  ->  %d results%n",
