...
class IngestionPipelineTest {
    ...
    class BuilderTests {
        ...
        @Test
        @DisplayName("throws when memory is null")
    ...
    class DirectIngest {
        ...
        void ingestsShortContentDirectly() {
            ...
            verify(mockMemory).remember("doc-1", "short text", sampleVector, MemoryType.SEMANTIC, MemorySource.OBSERVED);
        }
    ...
    class PreEmbeddedIngest {
        ...
        void ingestsPreComputedVector() {
            ...
            verify(mockMemory).remember("doc-pre", "text", preComputed, MemoryType.SEMANTIC, MemorySource.OBSERVED);
        }
    }
    ...
    class ChunkedIngest {
        ...
        void chunksLongContent() {
            ...
            verify(mockMemory, atLeastOnce()).remember(anyString(), anyString(), any(float[].class), eq(MemoryType.SEMANTIC), eq(MemorySource.OBSERVED));
        }
    }
}
