  ...
  template: `
    <div class="page-container">
      <header class="page-header">
        <h1>Settings</h1>
        <p class="subtitle">Configure providers, API keys, and system preferences</p>
      </header>
      <div class="placeholder-card">
        <span class="icon">⚙️</span>
        <p>Settings panel coming soon — provider management, API key configuration, and system preferences.</p>
      </div>
    </div>
  `,
  styles: [`
