...
class McpToolsFunctionalTest {
    ...
    static void setUp() {
        ...
        try {
            ...
            System.out.printf("✅ Ollama connected: %d dims from %s%n", dims, EMBED_MODEL);
        } catch (Exception e) {
            ollamaAvailable = false;
            System.out.printf("⚠️  Ollama NOT available: %s%n", e.getMessage());
        ...
        if (ollamaAvailable) {
            ...
            runtime = SpectorRuntime.from(props, new com.spectrayan.spector.embed.EmbeddingProvider() {
    ...
    void rememberSemantic() throws Exception {
        ...
        try {
            ...
            System.out.printf("  ✅ Verified: found in recall results%n");
        } catch (Exception e) {
            ...
            while (t != null) {
                if (t.getMessage() != null && t.getMessage().contains("capacity")) {
                    System.out.printf("%n══ Test 2: memory_remember SEMANTIC ══%n");
                    System.out.printf("  ⚠️  Store full (capacity 10K reached). Skipping.%n");
    ...
    void reinforce() {
        ...
        System.out.printf("  After reinforce, still in recall: %s ✅%n", found);
    ...
    void suppressAndUnsuppress() {
        ...
        System.out.printf("  Unsuppressed ft-episodic-001 ✅%n");
    }
    ...
    void forget() {
        ...
        System.out.printf("  Recall after forget: found=%s (expect false) ✅%n", found);
    ...
    void finalStatus() {
        ...
        System.out.printf("  Ollama:     %s%n", ollamaAvailable ? "✅ Available" : "⚠️  Offline (read-only mode)");
